    ...
    <>
      ...
      <aside className={`sidebar ${open ? 'open' : ''}`}>
        ...
        <div className="sidebar-logo">
          ...
          <div>
            <div className="sidebar-logo-title">Nizaam.com</div>
            <div className="sidebar-logo-sub">Digital Invoicing · Pakistan</div>
          </div>
        </div>
      ...
      <header className="mobile-topbar">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="font-display font-bold text-neutral-800 text-base">Nizaam.com</span>
        </div>
